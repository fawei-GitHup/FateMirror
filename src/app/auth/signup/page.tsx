        ...
        <Card className="card-glow w-full max-w-md border-border/30 bg-card/60 backdrop-blur">
          ...
          <CardContent>
            <Link href="/auth/login">
              <Button variant="outline" className="w-full border-border/50 hover:border-primary/30">
                {t('backToLogin')}
              </Button>
            </Link>
          </CardContent>
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <Card className="card-glow w-full max-w-md border-border/30 bg-card/60 backdrop-blur">
        <CardHeader className="text-center">
          ...
          <CardDescription>{t('beginJourney')}</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Button
            variant="outline"
            className="w-full border-border/50 bg-secondary/50 hover:border-primary/30 hover:bg-secondary"
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="separator-glow w-full" />
            </div>
          ...
          <form onSubmit={handleEmailSignup} className="space-y-3">
            <Input
              ...
              required
              className="border-border/40 bg-secondary/30 focus:border-primary/50"
            />
            <Input
              type="password"
            ...
            <Button type="submit" className="btn-gradient w-full border-0 text-white" disabled={loading}>
          ...
          <p className="text-center text-xs text-muted-foreground/60">{t('termsNotice')}</p>
        </CardContent>
      </Card>
    </div>
  );
